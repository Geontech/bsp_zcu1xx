...
% TODO / FIXME - determine product lifecycle implementation for this worker
%	\hline
%	Release Version  & v\docVersion (release date \color{red}N/A) \\

	\hline
	Latest Supported OpenCPI Version & \color{red}unreleased version with custom modifications \\%v1.4 \cite{github_opencpi_v1p4} \\
	\hline
...
\section{Functionality}
  ...
  timebase interface on the Xilinx Zynq UltraScale+ RFSoC ZCU111 Evaluation Kit
  \cite{zcu11_website}. The control and data planes interface with the zeroth
...
\section{Worker Implementation Details}
  ...
  \framebox{
    \parbox{0.8\linewidth}{
      ...
      This worker's useGP1 property refers to the GP ports of the generated IP
      core. The UltraScale+ Device Technical Reference Manual (TRM) refers to
      the IP core's GP ports as High Performance (HP) ports.
    }
  }
  \end{center}
...
\begin{thebibliography}{1}
  ...
  \bibitem{zcu11_website} Zynq UltraScale+ RFSoC Evaluation Kit \\
